...
      menuitem.tabIndex = -1; // Initial state: only the first item in HTML should be 0
...
  setFocusToMenuitem(newMenuitem) {
    ...
    // 2. Programmatically apply focus to the new/active element
    newMenuitem.focus();
    
    // 3. Update the tabindex of the focused element to "0"
...
  onMenuitemMouseover(event) {
    // Only move focus on mouseover if the menu is open
    if (this.isOpen()) {
        var tgt = event.currentTarget;
        // This implicitly calls setFocusToMenuitem due to the tab/focus logic
